...
public class WorkflowView {
     ...
     * constructor
     */
    public WorkflowView(Document document) throws IOException {
        this.document = document;

        final ExtendedFXMLLoader<WorkflowViewController> extendedFXMLLoader = new ExtendedFXMLLoader<>(this.getClass());
     ...
     * @param horizontal
     */
    private void assignNodeViewsAndCoordinatesForChildrenRec(WorkflowView workflowView, ANode v, Map<ANode, WorkflowNodeView> node2nodeView, double xDelta, double yDelta, boolean horizontal) {
    ...
    public void show() {
        stage = new Stage();
        stage.setTitle("Workflow - SplitsTree5");
