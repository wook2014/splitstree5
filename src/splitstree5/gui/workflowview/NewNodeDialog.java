...
public class NewNodeDialog {
     ...
     * @throws IOException
     */
    public NewNodeDialog(final WorkflowView workflowView, WorkflowNodeView sourceNodeView, MouseEvent me) throws IOException {
     ...
     * @param yTarget
     */
    private void makeNewNodes(final WorkflowView workflowView, WorkflowNodeView sourceNodeView, ADataBlock childDataBlock, double xTarget, double yTarget) {
