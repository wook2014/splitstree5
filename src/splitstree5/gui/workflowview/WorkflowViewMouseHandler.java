...
public class WorkflowViewMouseHandler {
     ...
     * @param nodeView
     */
    private WorkflowViewMouseHandler(WorkflowView workflowView, Pane world, WorkflowNodeView nodeView) {
     ...
     * @param nodeView
     */
    public static void install(WorkflowView workflowView, Pane world, WorkflowNodeView nodeView) {
