...
public class RootedNetworksBlock extends ADataBlock {
     ...
     * @param that
     */
    public void copy(RootedNetworksBlock that) {
        clear();
    ...
    public String getInfo() {
        return (getNNetworks() == 1 ? "a rooted network" : getNNetworks() + " rooted networks") + (isPartial() ? ", partial" : "");
    }
}
