...
import splitstree5.core.algorithms.distances2splits.neighbornet.NeighborNetPCG.CircularConjugateGradient;
import splitstree5.core.algorithms.distances2splits.neighbornet.NeighborNetPCG.CircularSplitAlgorithms;
import splitstree5.core.algorithms.distances2splits.neighbornet.NeighborNetPCG.DualPCG;
import splitstree5.core.algorithms.distances2splits.neighbornet.NeighborNetPCG.VectorUtilities;
...
import static splitstree5.core.algorithms.distances2splits.neighbornet.NeighborNetPCG.VectorUtilities.*;
    ...
    static public void circularActiveSet(int nTax, double[] d, double[] x, ProgressListener progress, NNLSParams params) {
        ...
        while (true) {
            ...
            */
            ...
            CircularSplitAlgorithms.circularAx(nTax,x,s);
            for (int i = 1; i <= npairs; i++) {
                s[i] -= d[i];
            }
            CircularSplitAlgorithms.circularAtx(nTax,s,grad);
