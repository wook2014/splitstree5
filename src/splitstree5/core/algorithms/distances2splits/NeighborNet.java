...
public class NeighborNet extends Algorithm<DistancesBlock, SplitsBlock> implements IFromDistances, IToSplits {
    ...
    public final static String CITATION =" D. Bryant and V. Moulton.  NeighborNet:  An agglomerative method for the construction of " +
            "planar phylogenetic networks.  In R. Guig ́o and D. Gusfield, editors, " +
            "Algorithms  in  Bioinformatics, WABI 2002 , volume LNCS 2452, pages 375–391, 2002.";
    ...
    private static int[] runNeighborNet(ProgressListener progress, int ntax, double[][] dist) throws CanceledException {
        ...
        double[][] D = setupMatrix(ntax, dist);

        final NetNode netNodes = new NetNode();
     ...
     */
    static private int agglomNodes(ProgressListener progress, Stack<NetNode> amalgs, double D[][], NetNode netNodes, int num_nodes) throws CanceledException {
     ...
     */
    static private NetNode agg3way(NetNode x, NetNode y, NetNode z, Stack<NetNode> amalgs, double[][] D, NetNode netNodes, int num_nodes) {
...
/* Update distance matrix */
     ...
     */
    static private int agg4way(NetNode x2, NetNode x, NetNode y, NetNode y2, Stack<NetNode> amalgs, double[][] D, NetNode netNodes, int num_nodes) {
