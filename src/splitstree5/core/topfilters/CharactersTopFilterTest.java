 ...
 */
public class CharactersTopFilterTest extends Application {
    @Override
    public void start(Stage primaryStage) throws Exception {
        ...
        {
            new CharactersTopFilter(document.getWorkflow().getTopTaxaNode(), document.getWorkflow().getWorkingTaxaNode(), document.getWorkflow().getTopDataNode(),
