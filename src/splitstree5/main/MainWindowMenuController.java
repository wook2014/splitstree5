/*
 * MainWindowMenuController.java Copyright (C) 2021. Daniel H. Huson
 *
...
import splitstree5.core.algorithms.characters2distances.ProteinMLdist;
import splitstree5.core.algorithms.characters2distances.Uncorrected_P;
import splitstree5.core.algorithms.characters2distances.nucleotide.*;
        ...
        controller.getOpenMenuItem().setOnAction(e -> {
            ...
            if (selectedFile != null) {
                ...
                if (WorkflowNexusInput.isApplicable(selectedFile.getPath()))
                    ...
                    FileOpener.open(false, mainWindow, mainWindow.getMainWindowController().getBottomPane(), selectedFile.getPath(), null);
            }
        });
